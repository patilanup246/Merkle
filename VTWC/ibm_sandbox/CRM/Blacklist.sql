...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Parsed email without obsfucation prefix',
    @level0type = N'SCHEMA',
    @level0name = N'CRM',
    @level1type = N'TABLE',
    @level1name = N'Blacklist',
    @level2type = N'COLUMN',
    @level2name = N'ParsedAddress'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Individual Identifier',
    @level0type = N'SCHEMA',
    @level0name = N'CRM',
    @level1type = N'TABLE',
    @level1name = N'Blacklist',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Reason for exclusion',
    @level0type = N'SCHEMA',
    @level0name = N'CRM',
    @level1type = N'TABLE',
    @level1name = N'Blacklist',
    @level2type = N'COLUMN',
    @level2name = N'ExclusionReason'