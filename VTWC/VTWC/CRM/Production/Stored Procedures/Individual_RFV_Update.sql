...
--     IF OBJECT_ID('CEM.Production.Ind_RFV_Summary', 'U') IS NOT NULL
--       DROP TABLE CEM.Production.Ind_RFV_Summary
--
--     SELECT *
--     INTO CEM.Production.Ind_RFV_Summary
--     FROM #tmp_segment

    -- CLEAR EXISTING SEGMENTATION
    UPDATE [Production].[Individual] SET SegmentTierID = null;

    UPDATE ind
    SET ind.SegmentTierID = tmp.SegmentID
    FROM Production.Individual ind INNER JOIN #tmp_segment tmp ON ind.IndividualID = tmp.IndividualID
