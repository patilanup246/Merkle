CREATE PROCEDURE [Reference].[TicketClass_Set]
(
	@userid                 INTEGER = 0,
	@name                   NVARCHAR(256),
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1
                   FROM [Reference].[TicketClass]
		    	   WHERE Name = @name)
    BEGIN
        INSERT INTO [Reference].[TicketClass]
           ([Name]
           ,[Description]
           ,[CreatedDate]
           ,[CreatedBy]
