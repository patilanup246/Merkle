/*===========================================================================================
Name:			Reference.ModeOfTransport_Upsert
Purpose:		Insert/Update Mode of transport reference data into table Reference.ModeOfTransport
...
Modified:		
Peer Review:	
Call script:	EXEC Reference.ModeOfTransport_Upsert
=================================================================================================*/

CREATE PROCEDURE [Reference].[ModeOfTransport_Upsert]
(
	@userid                INTEGER = 0,
...
BEGIN
	...
	SET @ProcName = 'Reference.ModeOfTransport_Upsert'

	SET @StepName = 'Insert/Update mode of transport reference information';
	BEGIN TRY   		
		EXEC uspAuditAddAudit @AuditType='TRACE START', @ProcessStep='Insert/Update mode of transport reference information start'
                        ,@Process=@spname, @DatabaseName=@dbname, @Rows=null, @PrintToScreen=@DebugPrint

		MERGE Reference.ModeOfTransport AS TRGT
		USING #ModeOfTransport AS SRC
		...
		EXEC uspAuditAddAudit @AuditType='TRACE END', @ProcessStep='Insert/Update mode of transport reference information finish'
