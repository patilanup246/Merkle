CREATE TABLE [Staging].[STG_Journey] (
    ...
    CONSTRAINT [cndx_PrimaryKey_STG_Journey] PRIMARY KEY CLUSTERED ([JourneyID] ASC),
    ...
    CONSTRAINT [FK_STG_Journey_LocationIDDestination] FOREIGN KEY ([LocationIDDestination]) REFERENCES [Reference].[Station] ([StationID]),
    CONSTRAINT [FK_STG_Journey_LocationIDOrigin] FOREIGN KEY ([LocationIDOrigin]) REFERENCES [Reference].[Station] ([StationID]),
    CONSTRAINT [FK_STG_Journey_SalesDetailID] FOREIGN KEY ([SalesDetailID]) REFERENCES [Staging].[STG_SalesDetail] ([SalesDetailID]),
    CONSTRAINT [FK_STG_Journey_TOCID] FOREIGN KEY ([TOCIDPrimary]) REFERENCES [Reference].[TOC] ([TOCID]),
