...
/*===========================================================================================
Name:			uspSSISPopulateDimTime
Purpose:		Populates the time dimension.
Parameters:		@MorningStart	hour representing start of Morning period expressed as a tinyint
				@AfternoonStart	hour representing start of Afternoon period expressed as a tinyint
				@EveningStart	hour representing start of Evening period expressed as a tinyint
				@NightStart		hour representing start of Night period expressed as a tinyint
...
Created:		2010-02-18	Tim Cooke
Modified:		2010-03-03  PhilipR Added call for default build of time dimension at end of script.
				2011-03-21  Colin Thomas. Updated timekey to be HHMM format to allow time related queries on the key
				2011-11-28  Steve Blackman. Added audit key defaults.
Peer Review:	
Call script:	EXEC uspSSISPopulateDimTime 8,12,17,20
=================================================================================================*/
CREATE PROCEDURE dbo.uspSSISPopulateDimTime
...
DELETE FROM DimTime WHERE TimeKey > -1
