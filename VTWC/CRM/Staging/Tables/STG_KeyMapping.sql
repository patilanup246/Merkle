CREATE TABLE [Staging].[STG_KeyMapping] (
    ...
    CONSTRAINT [cndx_PrimaryKey_STG_KeyMapping] PRIMARY KEY CLUSTERED ([KeyMappingID] ASC) WITH (FILLFACTOR = 80),
...
GO
CREATE NONCLUSTERED INDEX [dba_nci_IndividualID_IsParentInd]
    ON [Staging].[STG_KeyMapping]([IndividualID] ASC, [IsParentInd] ASC)
    INCLUDE([CustomerID], [KeyMappingID]) WITH (FILLFACTOR = 80);
