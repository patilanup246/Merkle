CREATE TABLE [Reference].[MSD_Entity] (
...
GO
CREATE NONCLUSTERED INDEX [ix_MSD_Entity_PhysicalName]
    ON [Reference].[MSD_Entity]([PhysicalName] ASC, [ComponentState] ASC, [OverwriteTime] ASC);
