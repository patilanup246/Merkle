/*===========================================================================================
Name:			Reference.TicketClass_Upsert
Purpose:		Insert/Update Ticket Class reference data into table Reference.TicketClass
...
Modified:		
Peer Review:	
Call script:	EXEC Reference.TicketClass_Upsert
=================================================================================================*/

CREATE PROCEDURE [Reference].[TicketClass_Upsert]
(
	@userid                INTEGER = 0,
...
BEGIN
	...
	SET @ProcName = 'Reference.TicketClass_Upsert'

	SET @StepName = 'Insert/Update TicketClass reference information';
	BEGIN TRY   		
		EXEC uspAuditAddAudit @AuditType='TRACE START', @ProcessStep='Insert/Update Ticket class reference information start'
                        ,@Process=@spname, @DatabaseName=@dbname, @Rows=null, @PrintToScreen=@DebugPrint

		MERGE Reference.TicketClass AS TRGT
		USING #TicketClass AS SRC
		...
		EXEC uspAuditAddAudit @AuditType='TRACE END', @ProcessStep='Insert/Update Ticket class reference information finish'
