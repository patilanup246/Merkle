...
BEGIN
	...
	BEGIN TRY   		
		...
		AND TRGT.TicketClassID = SRC.TicketClassID
		WHEN NOT MATCHED THEN
		INSERT ([Name],[CreatedDate],[CreatedBy],[LastModifiedDate],[LastModifiedBy]
		        ,[ArchivedInd],[InformationSourceID],[TicketTypeCode],TicketClassID, ExtReference)
		VALUES ([Name], @now, @userid, @now, @userid, 0, InformationSourceID, [TicketTypeCode],TicketClassID, -1)
		WHEN MATCHED 
