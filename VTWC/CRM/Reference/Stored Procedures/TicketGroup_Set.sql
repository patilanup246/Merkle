CREATE PROCEDURE [Reference].[TicketGroup_Set]
(
	@userid                 INTEGER = 0,
	@name                   NVARCHAR(256),
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1
                   FROM [Reference].[TicketGroup]
		    	   WHERE Name = @name)
    BEGIN
        INSERT INTO [Reference].[TicketGroup]
           ([Name]
           ,[Description]
           ,[CreatedDate]
           ,[CreatedBy]
