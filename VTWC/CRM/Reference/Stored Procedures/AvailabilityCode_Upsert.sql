/*===========================================================================================
Name:			Reference.AvailabilityCode_Upsert
Purpose:		Insert/Update AvailabilityCode reference data into table Reference.AvailabilityCode
...
Modified:		
Peer Review:	
Call script:	EXEC Reference.AvailabilityCode_Upsert
=================================================================================================*/

CREATE PROCEDURE [Reference].[AvailabilityCode_Upsert]
(
	@userid                INTEGER = 0,
...
BEGIN
	...
	SET @ProcName = 'Reference.AvailabilityCode_Upsert'

	SET @StepName = 'Insert/Update AvailabilityCode reference information';
	BEGIN TRY   		
		EXEC uspAuditAddAudit @AuditType='TRACE START', @ProcessStep='Insert/Update AvailabilityCode reference information start'
                        ,@Process=@spname, @DatabaseName=@dbname, @Rows=null, @PrintToScreen=@DebugPrint

		MERGE Reference.AvailabilityCode AS TRGT
		USING #AvailabilityCode AS SRC
		...
		EXEC uspAuditAddAudit @AuditType='TRACE END', @ProcessStep='Insert/Update AvailabilityCode reference information finish'
