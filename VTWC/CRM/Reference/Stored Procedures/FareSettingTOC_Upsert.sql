...
/*===========================================================================================
Name:			Reference.FareSettingTOC_Upsert
Purpose:		Insert/Update Fare setting TOC reference data into table Reference.FareSettingTOC
...
Created:		2018-09-26	Dhana Mani
Modified:		
Peer Review:	
Call script:	EXEC Reference.FareSettingTOC_Upsert
=================================================================================================*/

CREATE PROCEDURE [Reference].[FareSettingTOC_Upsert]
(
	@userid                INTEGER = 0,
...
BEGIN
	...
	SET @ProcName = 'Reference.FareSettingTOC_Upsert'

	SET @StepName = 'Insert/Update Fare Setting TOC reference information';
	BEGIN TRY   		
		EXEC uspAuditAddAudit @AuditType='TRACE START', @ProcessStep='Insert/Update Fare Settng TOC reference information start'
                        ,@Process=@spname, @DatabaseName=@dbname, @Rows=null, @PrintToScreen=@DebugPrint

		MERGE Reference.FareSettingTOC AS TRGT
		USING #FareSettingTOC AS SRC
		...
		EXEC uspAuditAddAudit @AuditType='TRACE END', @ProcessStep='Insert/Update Fare Setting TOC reference information finish'
