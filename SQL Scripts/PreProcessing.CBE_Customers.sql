...
/****** Object:  StoredProcedure [PreProcessing].[CBE_Customers]    Script Date: 23/07/2018 15:52:49 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	;WITH CTE_Matching_Customers AS (
				...
				WHERE km.CBECustomerID IS NOT NULL
																 )
	...
	INNER JOIN CTE_Matching_Customers b ON a.ID = b.ID
	WHERE DataImportDetailID = @dataimportdetailid
	AND    ProcessedInd = 0
    ...
    FROM   PreProcessing.CBE_Customer
